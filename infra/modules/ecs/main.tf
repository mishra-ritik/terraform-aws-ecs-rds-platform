# -----------------------------------------------------------------------------
# ECS module
# Internet -> ALB (public subnets) -> ECS/Fargate service (private subnets)
# Also exposes the ECS task security group so the RDS module can allow it in.
# -----------------------------------------------------------------------------
...
resource "aws_lb_target_group" "this" {
  ...
  protocol    = "HTTP"
  vpc_id      = var.vpc_id
  target_type = "ip" # Fargate registers targets by IP
...
resource "aws_ecs_service" "this" {
  ...
  # Give the ALB listener time to exist before the service registers targets.
